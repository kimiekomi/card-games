...
class TestBlackJack(unittest.TestCase):
    ...
    #     print("testing is_blackjack()")
    #     self.assertEqual(is_blackjack(blackjack_true), True)
    #     self.assertEqual(is_blackjack(blackjack_false), False)


    # def is_ace(self):
    #     print("testing is_ace()")
    #     self.assertEqual(is_ace(Ace_of_Spades), True)
    #     self.assertEqual(is_ace(Seven_of_Spades), False)


    # def test_dealer_move(self):
    #     print("testing dealer_move()")
