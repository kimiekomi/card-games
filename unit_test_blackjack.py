...
class TestBlackJack(unittest.TestCase):
    ...
    def test_get_value(self):
        ...
        self.assertEqual(get_value(Ace_of_Hearts), 11)
        self.assertEqual(get_value(Two_of_Hearts), 2)
        self.assertEqual(get_value(Three_of_Hearts), 3)
        self.assertEqual(get_value(Four_of_Hearts), 4)
        self.assertEqual(get_value(Five_of_Hearts), 5)
        self.assertEqual(get_value(Six_of_Hearts), 6)
        self.assertEqual(get_value(Seven_of_Hearts), 7)
        self.assertEqual(get_value(Eight_of_Hearts), 8)
        self.assertEqual(get_value(Nine_of_Hearts), 9)
        self.assertEqual(get_value(Ten_of_Hearts), 10)
        self.assertEqual(get_value(Jack_of_Hearts), 10)
        self.assertEqual(get_value(Queen_of_Hearts), 10)
        self.assertEqual(get_value(King_of_Hearts), 10)


    def test_calculate_total(self):
        print("testing calculate_total()")
        self.assertEqual(calculate_total(sample_hand1), 20)
        self.assertEqual(calculate_total(sample_hand2), 31)
        self.assertEqual(calculate_total(sample_hand3), 21)
        self.assertEqual(calculate_total(sample_hand4), 21)
        self.assertEqual(calculate_total(sample_hand5), 21)
        self.assertEqual(calculate_total(sample_hand6), 21)
